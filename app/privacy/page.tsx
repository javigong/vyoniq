...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Privacy Policy | Vyoniq",
    description: "Learn how Vyoniq protects your privacy and handles your personal information.",
      ...
      <section className="py-20 bg-white dark:bg-vyoniq-dark-bg">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-vyoniq-blue dark:text-white mb-8">Privacy Policy</h1>
            <p className="text-lg text-vyoniq-text dark:text-vyoniq-dark-text mb-8">Last updated: January 11, 2025</p>

            <div className="prose prose-lg dark:prose-invert max-w-none">
              <div className="space-y-8">
                <section>
                  <h2 className="text-2xl font-bold text-vyoniq-blue dark:text-white mb-4">1. Introduction</h2>
                  <p className="text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                    Vyoniq ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-vyoniq-blue dark:text-white mb-3">Personal Information</h3>
                  <p className="text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                  ...
                  <ul className="list-disc pl-6 text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                    ...
                    <li>Join the Vyoniq Tables waitlist</li>
                    <li>Communicate with us via email or other channels</li>
                    <li>Use our services or engage with our AI development tools</li>
                  </ul>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                    ...
                    <li>Sending you updates about our services and Vyoniq Tables development</li>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-vyoniq-blue dark:text-white mb-4">5. Data Security</h2>
                  <p className="text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-vyoniq-blue dark:text-white mb-4">6. Your Rights</h2>
                  <p className="text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-vyoniq-blue dark:text-white mb-4">7. Cookies</h2>
                  <p className="text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-vyoniq-blue dark:text-white mb-4">9. Contact Us</h2>
                  <p className="text-vyoniq-text dark:text-vyoniq-dark-text mb-4">
