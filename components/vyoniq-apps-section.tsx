        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 lg:pr-8">
            <h2 className="text-3xl md:text-4xl font-bold text-vyoniq-blue dark:text-white mb-6">
              Vyoniq Apps: Coming Soon to Revolutionize Data Management
            </h2>
            <p className="text-lg text-vyoniq-text dark:text-vyoniq-dark-text mb-8 leading-relaxed">
              Our AI-powered app, in development, will simplify data entry and
              enable seamless chat interactions via MCP servers. Experience the
              future of intelligent data management with automated workflows and
