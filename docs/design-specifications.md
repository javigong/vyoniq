...
- **Authentication**: Clerk for waitlist sign-up and dashboard.
...
- **Header**:
  ...
  - Nav Links: “Home,” “Services,” “Vyoniq Tables,” “About,” “Contact” (right-aligned, hover: #00C7B7 underline).
...
- **Hero Section**:
  ...
  - Content:
    ...
    - Subheadline: “Web & Mobile Apps, Hosting, AI Integrations, and Coming Soon: Vyoniq Tables for Smart Data Management” (18px, #F5F5F7/0.8).
    - CTAs: Two shadcn/ui buttons:
      - “Get a Quote” (#6E56CF, hover: brighten, links to contact form).
      - “Join Vyoniq Tables Waitlist” (outline, #F5F5F7, hover: #00C7B7 fill, links to sign-up).
...
- **Vyoniq Tables Announcement**:
  ...
  - Content:
    - Title: “Vyoniq Tables: Coming Soon to Revolutionize Data Management” (H2, #0F1729).
    - Description: “Our AI-powered app, in development, will simplify data entry and enable seamless chat interactions via MCP servers.” (16px, #1D1D1F).
    - CTA: “Join the Waitlist” (shadcn/ui button, #6E56CF, links to sign-up).
    - Visual: Mockup of data table + chat UI (Next.js Image, “In Development” watermark, #00C7B7 accents).
...
- **Contact Form**:
  - shadcn/ui Form with fields: Name (text), Email (email), Service Type (select: Web/Mobile, Hosting, AI, Vyoniq Tables Interest), Message (textarea).
...
- **Template** (for Web/Mobile, Hosting, AI Integrations):
  ...
  - Layout: 60% text, 40% visual (stack on mobile).
- **Vyoniq Tables Page**:
  - Hero: “Vyoniq Tables: Coming Soon” (H1, #0F1729).
  - Content:
    - Description: Planned features (AI data entry, MCP server chat), note “In Development” (16px, #1D1D1F).
    - CTA: “Join Waitlist” (#6E56CF, links to sign-up).
    - Visual: Mockup with “Work in Progress” watermark (#00C7B7 accents).
...
- **Sign-Up (Vyoniq Tables Waitlist)**:
  ...
  - CTA: “Join Waitlist” (#6E56CF).
  - Layout: Centered, 400px wide, glassmorphism card (bg-opacity: 0.1, blur: 20px, #F5F5F7 base).
- **Dashboard**:
  - Simple layout: Welcome message, waitlist status (“You’re on the list!”), “Vyoniq Tables in development” note (#1D1D1F).
...
- **SEO**:
  - Meta tags: Title (“Vyoniq | AI-Powered Software Solutions”), description (150-160 chars), keywords (AI, software development, Vyoniq Tables).
...
- Pages: Homepage, Service pages (3), Vyoniq Tables page, About page, Sign-Up, Dashboard.
- shadcn/ui components styled with Tailwind CSS using the updated palette.
- Clerk authentication integrated for waitlist.
...
- Vyoniq Tables mockups should be conceptual with a “In Development” watermark (#00C7B7 text).
